                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                                <h2 class="section-heading mb-4">
                                     <span class="section-heading-lower">tavoli e sedie</span>
                                </h2>
                                <p class="mb-3">Esempi di tavoli e sedie.
                                </p>
                                <div class="intro-button mx-auto">
                                    <a class="btn btn-primary btn-xl" href="stanza-virtuale.php">Make your dream a home!</a>
                                </div>
                            </div> 
                            <img class="d-block w-75" src="img/sheffield-antica.jpg" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            ...
                            <img class="d-block w-75" src="img/fiera-esposizione.jpg" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <div class="intro-text left-0 text-center bg-faded p-5 rounded">
                                <h2 class="section-heading mb-4">
